```javascript
// ==UserScript==
// @name         Clip Follow Tool (Robust + Versioned UI)
// @namespace    https://local
// @version      1.5.1
// @description  팔로워 탭이면 즉시 시작, 아니면 @creator_clip 팔로워 탭으로 이동 후 자동 시작. 파도 100회 후 종료, 후보 부족 보강 스캔. UI에 빌드 버전/시간 표시.
// @match        https://clip.naver.com/*
