(()=>{
  ...
  const S={run:true,delay:650,scrollDelay:900,empty:0,scrolls:0,totalFollow:0,totalSurf:0,
           ...
           clickedFollows:new Set()}; // ✅ 세션 내 중복 카운트 방지
  ...
  async function clickAllFollows(){
    ...
    for(const b of btns){
      ...
      if(id && S.clickedFollows.has(id)) { b.dataset.__cf_clicked='1'; continue; } // 이미 센 계정
