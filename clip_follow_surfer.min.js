(()=>{
  ...
  const VERSION='Clip Follow Surfer v1.5.3';
  ...
  ui.innerHTML=`
    ...
    <div style="margin-top:10px;border-top:1px solid rgba(255,255,255,.16);padding-top:4px;font-size:10px;opacity:.7">
      ${VERSION}<br>배포 : 2025.08.14 00:00
    </div>
  `;
  ...
  function extractIdFromEl(el){
    ...
    if(!id){const t=(el&& (el.innerText||el.textContent)||'').trim();
  ...
  // 방문 기록은 저장만 하고, 선택에는 사용하지 않음(무시) + 랜덤 선택
